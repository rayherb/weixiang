<?php return array (
  ...
  array (
    ...
    array (
      ...
      'index.html' => '网站首页',
      'list.html' => '列表页',
	  'list_kehu.html' => '客户见证列表页',
      'list_download.html' => '下载列表页',
      'list_picture.html' => '图片列表页',
      'message.html' => '消息提示页',
      'page.html' => '单网页',
	  'page_about.html' => '关于我们单网页',
	  'page_contact.html' => '联系我们单网页',
      'rss.html' => 'RSS页',
      'search.html' => '搜索',
      'show.html' => '文章内容页',
    ...
    'templates|muju|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|muju|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|muju|yp|com_muju' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|muju|comment' => 
    array (
